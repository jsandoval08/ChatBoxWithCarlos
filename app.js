...
const joseSelectorBtn = document.querySelector('#jose-selector')
...
const updateMessageSender = (name) => {
  ...
  if (name === 'John') {
    ...
    joseSelectorBtn.classList.remove('active-person')
  }
  if (name === 'Jane') {
    carlosSelectorBtn.classList.add('active-person')
    joseSelectorBtn.classList.remove('active-person')
...
joseSelectorBtn.onclick = () => updateMessageSender('Jose')
